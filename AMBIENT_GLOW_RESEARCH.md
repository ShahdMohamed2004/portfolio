...
## ترقية الانعكاسات — Luxury restrained

بعد مراجعة الاتجاه المقترح، تمت إضافة نظام إضاءة منفصل فوق الـ ambient blobs الحالية، بدل زيادة قوة الألوان أو إضافة مؤثرات عشوائية:

- **Light Path:** انتقال ضوئي قطري خافت يصل بين الأخضر والليموني.
- **Reflection Field:** حقل انعكاس واسع ومموه يحاكي الضوء على سطح زجاجي مصقول.
- **Specular Ribbon:** شريط انعكاس رفيع منخفض الشدة، يظهر كلمعة لا كخط واضح.
- **Micro-Reflection:** تفاصيل شبه غير مرئية جدًا لتقليل الإحساس بأن الخلفية مجرد gradients.
- **Depth / Vignette:** طبقة حواف تحافظ على عمق الخلفية الخضراء الداكنة.
- **Restrained Motion:** تنفّس بطيء جدًا بين 24 و34 ثانية بحركة صغيرة، مع إيقافه تلقائيًا عند `prefers-reduced-motion`.

تمت معايرة الطبقات على درجات blur مختلفة بدل استخدام blur واحد لكل شيء: glow أساسي ناعم، مسار ضوئي متوسط، وspecular أكثر تحديدًا. كما تم تخفيض الشدة والـ blur على الهاتف للحفاظ على القراءة والأداء.

الفكرة الأساسية: **العين تلاحظ وجود الضوء قبل أن تلاحظ المؤثر نفسه**. لذلك بقيت ألوان النص والمحتوى والـ Hero هي الأولوية.

## Gradient Identity

تم اعتماد تدرج لوني واحد كهوية مشتركة بين الخلفية والعناصر، يبدأ من `#031A12` ثم يمر عبر `#4ADE80` وينتهي بلمسة `#FDE047`. لا يتم وضع هذا التدرج على النصوص الطويلة؛ بل يُستخدم في:

- الزر الأساسي وactive work filter.
- لمعات البطاقات والأسطح الزجاجية.
- خطوط الفصل ومؤشرات الأقسام.
- اللمعة الهادئة داخل عنوان الـ Hero.

أما النصوص الصغيرة والـ labels فتبقى بلون ثابت عالي التباين. هذا يمنع التدرج من إضعاف القراءة، ويجعل اللون يعمل كتوقيع بصري بدل أن يصبح ضوضاء مستمرة.
